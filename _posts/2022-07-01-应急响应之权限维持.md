...
![](img/privilege-1-1.png)

如果要让文件显示出来，就点击查看，勾选显示隐藏的文件，文件就显示出来。

![](img/privilege-1-2.png)
...
![](img/privilege-1-19.png)

当执行这条命令的同时，将在安全日志中留下痕迹，

![](img/privilege-1-20.png)
...
![](img/privilege-5-2.png)

进入/root/.ssh/文件夹，查看文件夹的内容，如下所示：

![](img/privilege-5-3.png)
...
![](img/privilege-5-4.png)

排查技巧：进程、端口都可以发现异常， kill -s 9 PID 结束进程即可清除后门。

![](img/privilege-5-4-1.png)
...
![](img/privilege-5-5-1.png)

排查技巧：使用`alias`即可发现异常。

![](img/privilege-5-5-2.png)
...
![](img/20200413-12-1.png)

步骤二：通过url访问，可以查看恶意代码。

![](img/20200413-12-2.png)
...
![](img/privilege-3-15.png)

 账号注销后，重新登录，界面上会出现powershell快速闪过消失，成功返回shell。

![](img/privilege-3-16.png)
...
![](img/privilege-6-4.png)

**5、Xise**

XISE WebShell管理工具。

![](img/privilege-6-5.png)
